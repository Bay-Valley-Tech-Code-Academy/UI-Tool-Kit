  ...
  return (
    <nav className="md:flex sticky bg-indigo-900 opacity-100 p-4 px-20 gap-50">
      ...
      <div className="flex flex-1 justify-center gap-7 mt-1 text-white font-medium text-xl">
        <button className="hover:bg-gradient-to-r from-indigo-500 to-violet-700 p-3 rounded-lg drop-shadow-xl">
          Home
        </button>
        <button className="hover:bg-gradient-to-r from-indigo-500 to-violet-700 p-3 rounded-lg drop-shadow-xl">
          Product List
        </button>
        <button className="hover:bg-gradient-to-r from-indigo-500 to-purple-600 p-3 rounded-lg drop-shadow-xl">
          Cart
        </button>
        <button className="hover:bg-gradient-to-r from-indigo-500 to-violet-700 p-3 rounded-lg drop-shadow-xl">
          About
