  ...
  return (
    ...
    <div className="text-center">
      <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
        Welcome to the UI Tool Kit!
      </h1>
      <p className="mt-6 text-lg leading-8 text-gray-600">
        Use this template to create your own website. This website is a shop template. Click the blue button below to head to the product lists page.
      </p>
